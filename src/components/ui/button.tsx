...
/**
 * Shared pill CTA — renders an `<a>` when `href` is given, a `<button>`
 * otherwise. Centralizes the site's one button look (solid fill that
 * outlines on hover) so every call site stays in sync automatically.
 */
